...
public class Rights extends WWBaseObject {
    ...
    public Rights (){
         ...
         rightNames.put("Account.Merge", lastPosition++);
         rightNames.put("Account.Split", lastPosition++);
         rightNames.put("Account.Delete", lastPosition++);
         rightNames.put("Account.PHI.Read", lastPosition++);
         rightNames.put("Account.PHI.Write", lastPosition++);
         rightNames.put("Account.Supp.Read", lastPosition++);
         rightNames.put("Account.Supp.Write", lastPosition++);
